 ...
 * @author <Group 4>
 */
public class ManagerLogHistoryController {
...
//        String query = "SELECT * FROM public.log_history WHERE user_id = ? OR role = 'surveyor'";
//        try (PreparedStatement pstmt = conn.prepareStatement(query)) {
//            pstmt.setString(1, getSessionUserId());
...
private CompletableFuture<Void> loadData() {
    ...
    private String getSessionUserId() {
        // Assuming a session management class is available to get the current session user ID
