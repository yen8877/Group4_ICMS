...
public class DependentDAO {
    ...
    public boolean addCustomerAndDependent(DependentDTO dependent) {
        ...
        String sql1 = "INSERT INTO customer (c_id, insurancecard, password, phonenumber, address, email, customer_type, expirationdate, effectivedate, full_name) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try {
            ...
            pstmt1.setString(7, dependent.getCustomerType());
