...
public class Claims {
    ...
    // Constructor
    public Claims(String fId, ZonedDateTime claimDate, LocalDate examDate, double claimAmount, String insuredPersonId, String submittedById, String status, String bankingInfo, String claimDocuments, String message) {
        this.fId = fId;
