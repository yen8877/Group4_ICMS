...
public class SystemAdminController {
    ...
    public void testDeleteSystemAdminFromDatabase(String aId){
        deleteSystemAdminFromDatabase(aId);
    }
        ...
        CompletableFuture.runAsync(() -> {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(query); ResultSet rs = pstmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    Platform.runLater(() -> masterData.add(systemAdmin));
                }
            } catch (SQLException e) {
            ...
            if (masterData.isEmpty()) {
                Platform.runLater(() -> System.out.println("No system admins found."));
            }
        });}
//    private void loadData() {
//        Connection conn = JDBCUtil.connectToDatabase();
