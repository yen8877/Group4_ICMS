...
//    }
    @Override
    public void start(Stage stage) throws IOException {
        // Change the path to point to your add_CustomerbyPolicyOwner.fxml file
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/group4_icms/fxml/add_CustomerbyPolicyOwner.fxml"));
        Scene scene = new Scene(fxmlLoader.load(), 1440, 1024);
