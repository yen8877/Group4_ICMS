 ...
 * @author <Group 4>
 */
public class PolicyOwnerCustomerController {
    ...
    private CompletableFuture<Boolean> deleteCustomer(Customer customer) {
        /*Async method*/
...
//
//        String query = "SELECT * FROM public.customer WHERE policyowner_id = ?";
